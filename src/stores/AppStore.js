...
export const useAppStore = defineStore('app', () => {
    ...
    const isApiKeyProvided = computed(() => {return !!settings.apiKey})
    const tokensExceeded = computed(() => {return (tokensUsed.value >= settings.maxTotalTokens) && (settings.maxTotalTokens !== 0 ? settings.maxTotalTokens !== "" : false)})
    ...
    const generateConfiguration = () => {
        ...
        return settings.gptTurbo ? (a) => openai.createChatCompletion(a) : (a) => openai.createCompletion(a)
    }
    ...
    return {settingsHidden, tokensUsed, moneyUsed, messages, isApiKeyProvided, tokensExceeded, clearChat, createConversation}
})